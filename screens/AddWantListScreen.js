...
export default class AddCollectionScreen extends React.Component {
  ...
  async addToWantList() {
    if (this.state.quantityChoice !== '' && this.state.value !== '') {
      ...
      fetch(`https://api.narutoccg.com/api/v1/posts/${this.state.card._id}/want`, {
        method: 'POST',
        mode: 'cors',
        headers: {
          'Authorization': token,
      ...
      alert("Choose how many cards you want, and what you are willing to pay for each!");
    }
  }
  render() { 
    return (
          ...
          <KeyboardAvoidingView behavior={'padding'} enabled={Platform.OS === 'ios' ? true : false}>
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={styles.submitContainer}>
                  <TouchableOpacity onPress={() => this.addToWantList()} style={styles.submitButton}>
                    <Ionicons 
                      ...
                      color='white'
                    />
                    <Text style={styles.submitButtonText}>Add to Want List</Text>
                  </TouchableOpacity>
                </View>
